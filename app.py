...
if uploaded_file is not None:
    ...
    if st.sidebar.button("Show Analysis"):
        ...
        with col1:
            monthly_frequency = timeline[['year', 'month', 'message']]
            monthly_frequency['year'] = monthly_frequency['year'].astype(str).str.replace(',', '')
            st.dataframe(monthly_frequency)
